...
-->
                            ...
                            <div class="walletInputs">
                                <div class="info"> <span><?= $translations['amount'] ?></span>
                                    <div><?= $translations['min'] ?>. <span class="descriptionWallet" id="min_sum_deps"><?= $min_sum_dep ?></span> <?= $translations['max'] ?>. <span class="descriptionWallet">1 ml.</span></div>
                                </div>
