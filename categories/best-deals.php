...
<div class="main-container" id="main-content">
  ...
  <div class="GamesHeader__categoryTitle--aFh cms-games-grid-category-title">
    <h2 class="Headings__head--2LV Headings__bold--iD3 Headings__h2--3Bv Headings__dark--1eH GamesHeader__categoryName--WNE "><? echo $translations['best_deals_small'] ?></h2>
  </div>
