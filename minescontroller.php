...
if (!$sid) {
    $obj = array("info" => "warning", "warning" => $translations['you_need_log_in']);
} else {
if (isset($_POST['type'])){
...
mysqli_query($connection,$query);
                            ...
                            if ($mines == $mines){
                                ...
                                $obj = array(
                                    "info" => "warning",
                                    "warning" => <?= $translations['error_please_contact_support'] ?>
                                );
                            }
                        }
                    }else{
                        $obj = array(
                            "info" => "warning",
                            "warning" => <?= $translations['you_need_log_in'] ?>
                        );
                    }
                }
            }else{
                $obj = array(
                    "info" => "warning",
                    "warning" => <?= $translations['bet_amount_from_1'] ?>
                );
            }
        }
        else
        {
            $obj = array(
                "info" => "warning",
                "warning" => <?= $translations['not_enough_funds'] ?>
            );
        }
    }
    else
    {
        $obj = array(
            "info" => "warning",
            "warning" => <?= $translations['number_of_bombs_from_2'] ?>
        );
    }
}
}
if (isset($_POST['finish']))
{
    ...
    if ($step != "0")
    {
        if ($minesgame != null)
        {
            ...
            $query = ("UPDATE `users` SET `balance` = '$newbalance', wager = wager - '$betWAG', rakeback = rakeback + '$rakebackss' WHERE `id` = '$id'");
            mysqli_query($connection,$query);
            ...
            $query = ("UPDATE `mines` SET `onOff` = '2' WHERE `id_users` = '$id'");
            mysqli_query($connection,$query);
        ...
        else
        {
            $obj = array(
                "info" => "warning",
                "warning" => <?= $translations['the_game_does_not_exist_or_has_not_been_created_yet'] ?>
            );
        }
    }
    else
    {
        $obj = array(
            "info" => "warning",
            "warning" => <?= $translations['you_didnt_click_on_the_field'] ?>
        );
    }
}
...
if (isset($_POST['mmine']))
{
    ...
    $obj = array("info" => "warning", "warning" => $translations['you_have_already_clicked_on_this_cell']);
}
} else {
    $obj = array("info" => "warning", "warning" => $translations['to_select_a_cell_start_the_game']);
}
} else {
    $obj = array("info" => "warning", "warning" => $translations['an_error_occurred_mines'] . $mmines);
}
}
