						...
						<div class="footer-media">
							<div class="col-mob-4 col-dsk-4">
								<div class="footer-media-terms">
									...
									<a class="footer-media-terms-image" href="https://www.hollandcasino.nl/en/online/veilig-en-verantwoord-spelen" target="_self"><img alt="Terms" draggable="false" class="Image__image--2Bt Media__termsImage--17n" src="../images/HC_RG_LOGO_RGB.png"></a>
								</div>
							</div>
							<div class="col-mob-4 col-dsk-4">
								<div class="footer-media-sponsors">
									<a class="footer-media-image" href="https://kansspelautoriteit.nl/veilig-spelen/" target="_self">
										<img alt="REGULATORY Logo  1 - KSA Logo " draggable="false" class="footer-media-sponsors-image" src="../images/svgviewer-output.svg">
									</a>
								</div>
							</div>
						</div>
					...
					<div class="col-mob-4 col-dsk-6">
						<div class="footer-media-providers">
							...
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/playtech" target="_self">
								<img alt="Playtech" draggable="false" class="footer-media-providers-image" src="../images/providers/Playtech.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/pragmatic-play" target="_self">
								<img alt="Pragmatic Play" draggable="false" class="footer-media-providers-image" src="../images/providers/pragmatic.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/greentube" target="_self">
								<img alt="Greentube" draggable="false" class="footer-media-providers-image" src="../images/providers/greentube.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/play-n-go" target="_self">
								<img alt="Play N Go" draggable="false" class="footer-media-providers-image" src="../images/providers/playngo.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/games-global" target="_self">
								<img alt="Microgaming" draggable="false" class="footer-media-providers-image" src="../images/providers/gamesglobal.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/skywind-group" target="_self">
								<img alt="Skywind" draggable="false" class="footer-media-providers-image" src="../images/providers/skywind.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/igt" target="_self">
								<img alt="IGT" draggable="false" class="footer-media-providers-image" src="../images/providers/igt.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/ruby-play" target="_self">
								<img alt="Ruby Play" draggable="false" class="footer-media-providers-image" src="../images/providers/rubyplay.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/light-and-wonder" target="_self">
								<img alt="Light and Wonder" draggable="false" class="footer-media-providers-image" src="../images/providers/lightwonder.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/blueprint-gaming" target="_self">
								<img alt="Blueprint" draggable="false" class="footer-media-providers-image" src="../images/providers/blueprint.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/relax" target="_self">
								<img alt="Relax" draggable="false" class="footer-media-providers-image" src="../images/providers/relax.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/spinomenal" target="_self">
								<img alt="Spinomenal" draggable="false" class="footer-media-providers-image" src="../images/providers/spinomenal.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/quickspin" target="_self">
								<img alt="Quickspin" draggable="false" class="footer-media-providers-image" src="../images/providers/quickspin.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/bragg" target="_self">
								<img alt="Oryx" draggable="false" class="footer-media-providers-image" src="../images/providers/bragg.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/netent" target="_self">
								<img alt="Netent" draggable="false" class="footer-media-providers-image" src="../images/providers/netent.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/red-tiger" target="_self">
								<img alt="Red Tiger" draggable="false" class="footer-media-providers-image" src="../images/providers/redtiger.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/isoftbet" target="_self">
								<img alt="iSoftBet" draggable="false" class="footer-media-providers-image" src="../images/providers/isoftbet.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/habanero-games" target="_self">
								<img alt="Habanero" draggable="false" class="footer-media-providers-image" src="../images/providers/habanero.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/pariplay" target="_self">
								<img alt="Pariplay" draggable="false" class="footer-media-providers-image" src="../images/providers/pariplay.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/betsoft" target="_self">
								<img alt="Betsoft" draggable="false" class="footer-media-providers-image" src="../images/providers/betsoft.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/elk-studios" target="_self">
								<img alt="ELK Studios" draggable="false" class="footer-media-providers-image" src="../images/providers/elkstudios.svg">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/red-rake" target="_self">
								<img alt="Redrake" draggable="false" class="footer-media-providers-image" src="../images/providers/redrake.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/game-providers/kiron" target="_self">
								<img alt="Kiron" draggable="false" class="footer-media-providers-image" src="../images/providers/kiron.png">
							</a>
						...
						<div class="footer-media-payment">
							...
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/casino" target="_self">
								<img alt="Payment Method 1 - Ideal" draggable="false" class="footer-media-payment-image" src="../images/payments/ideal.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/casino" target="_self">
								<img alt="Payment Method 2 - VISA" draggable="false" class="footer-media-payment-image" src="../images/payments/visa.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/casino" target="_self">
								<img alt="Payment Method 3 - MasterCard" draggable="false" class="footer-media-payment-image" src="../images/payments/mastercard.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/casino" target="_self">
								<img alt="Payment Method 4 - Maestro" draggable="false" class="footer-media-payment-image" src="../images/payments/maestro.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/casino" target="_self">
								<img alt="Payment Method 5 - Trustly" draggable="false" class="footer-media-payment-image" src="../images/payments/trustly%20Payment.png">
							</a>
							<a class="footer-media-image" href="https://www.hollandcasino.nl/en/casino" target="_self">
								<img alt="Payment Method 6 - Paypal" draggable="false" class="footer-media-payment-image" src="../images/payments/paypal.webp?siteid=1">
							</a>
						</div>
					</div>
				</div>
