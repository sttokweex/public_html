...
<style>.loader{border: 4px solid #ffffff3b;border-top-color: #ffffff;border-radius: 50%;width: 48px;height: 48px;-webkit-animation: loader-spins 2s linear infinite;animation: loader-spins 2s linear infinite;display: flex;margin: 0 auto;}@keyframes loader-spins{0% {transform: rotate(0deg);}100% {transform: rotate(3turn);}}</style>
