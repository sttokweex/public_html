...
?>
    ...
    <div class="container">
        ...
        <div class="admin-card">
            <div class="header" style="    display: block;">ID #<span id="userid"><?= $userInf ?></span> <button class='buttonProject abs-btn' onClick="save_user_edit();">Сохранить данные</button>
                <div style="margin-top: 10px;" class="bord"></div>
            </div>
            <!-- CONTENT -->
