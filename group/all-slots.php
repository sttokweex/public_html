        ...
        <div class="banner-wrap favorite-page">
          <div class="banner favorite-page">
            <div class="left favorite-page">
              <h1 type="heading" variant="neutral-default" tag="h1" size="xl" class="text-neutral-default ds-heading-xl" data-ds-text="true"><?php echo htmlspecialchars($translations['all-slots']) ?></h1>
            </div>
