...
<div class="refferal">
      <div class="refferal__left">
          ...
          <div class="refferal__nav">
             ...
             <a href="/referals/reflist" class="active"><i class="fa fa-user-plus"></i> Ref</a>
        ...
        <div class="refferal__table">
            ...
            ?>
                ...
                <div class="content">
                    ...
                    <span class="title">None ref</span>
                    <span class="desc">Attract new users and earn up to 10% of the casino advantage.</span>
                    <button class="buttonProject w100" onClick="location.href='/referals/'">Go to</button>
                </div>
                </div>
                <?}else{?>
            ...
            <td>#$idref</td>
            <td><img class='referalPhoto' src='$imgref'>$loginref</td>
...
<a href="#" class="tabsIner active"> <i class="fa fa-user-plus"></i> Рефералы</a>
