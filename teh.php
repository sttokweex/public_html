...
?>
 ...
 <meta charset="UTF-8"/>
   <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <title><?=$sitename?><?= $translations['technical_work'] ?></title>
...
<h2>САЙТ НА ТЕХ ОБСЛУЖИВАНИИ</h2>
...
div{
  ...
  width: 100%;
  margin: 0px;
background: radial-gradient(circle, #1d1e27 0%, #17181f 100%);
  overflow: hidden;
}
...
h2{
  ...
  animation: fadeInText 3s ease-in 0.1s forwards, flicker4 5s linear 7.5s infinite, hueRotate 6s ease-in-out 3s infinite;
}
...
@keyframes flicker4{
  0%  {color: #ffc943;text-shadow:0px 0px 4px #ffc943;}
  30% {color: #ffc943;text-shadow:0px 0px 4px #ffc943;}
  31% {color: #eaca7c;text-shadow:0px 0px 4px #eaca7c;}
  32% {color: #ffc943;text-shadow:0px 0px 4px #ffc943;}
  36% {color: #ffc943;text-shadow:0px 0px 4px #ffc943;}
  37% {color: #eaca7c;text-shadow:0px 0px 4px #eaca7c;}
  41% {color: #eaca7c;text-shadow:0px 0px 4px #eaca7c;}
  42% {color: #ffc943;text-shadow:0px 0px 4px #ffc943;}
  85% {color: #ffc943;text-shadow:0px 0px 4px #ffc943;}
  86% {color: #eaca7c;text-shadow:0px 0px 4px #eaca7c;}
  95% {color: #eaca7c;text-shadow:0px 0px 4px #eaca7c;}
  96% {color: #ffc943;text-shadow:0px 0px 4px #ffc943;}
  100%{color: #ffc943;text-shadow:0px 0px 4px #ffc943;}
}

@keyframes fadeInText{
  1%  {color: #ffc943;text-shadow:0px 0px 4px #ffc943;}
  70% {color: #eaca7c;text-shadow:0px 0px 14px #eaca7c;}
  100%{color: #ffc943;text-shadow:0px 0px 4px #ffc943;}
}
